...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1488869110, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        block.nVersion = 1;
        block.nTime    = 1488869110;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 494551 : 494551;
        ...
        assert(block.hashMerkleRoot == uint256("0xc22fef1fddfb047e5c56780d1cb6e901720c4d303a99829496fc8dbe87d3a246"));
...
unsigned char pchMessageStart[4] = { 0xb5, 0x63, 0x0a, 0xfc };
